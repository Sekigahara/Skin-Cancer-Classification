...
### Analysis
  ...
  After that with swish, simultaneously Adam, RMSprop and SGD validation accuracy results are <b>71.10%</b>, <b>70.03%</b> and <b>20.71%</b>. The difference between Adam and RMSprop again is not significant. However in SGD cases the result is very underwhelming, the model cannot extract the proper features.  
